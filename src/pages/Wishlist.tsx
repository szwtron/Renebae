        ...
        <IonPage>
            ...
            <IonContent fullscreen className="ion-padding">
                <IonGrid>
                    ...
                    {dataArray && dataArray.map((dataArray: { idP: string; image: string; name: string; price: string; }) => (
                        <IonRow key={dataArray.idP}>
                            ...
                            <IonCol size="7">
                                ...
                                <IonRow>
                                    <IonCol>
                                        <IonButton color="success" fill="outline" onClick={() => addToCart(dataArray.idP, dataArray.image, dataArray.name, dataArray.price)} className="moveToBtn" expand="block">
                                ...
                                <IonRow>
                                    <IonCol>
                                        <IonButton onClick={() => deleteFromWishlist(dataArray.idP)} color="danger" fill="outline" className="removeBtn" expand="block">
