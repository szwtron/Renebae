...
const UpdateProduct: React.FC = () => {
    ...
    return (
        ...
        <IonContent fullscreen>
            ...
            {product.filter(product=>product.id === idprod).map(prod => (
                <IonGrid key={prod.name} className="ion-padding">
                    <IonRow>
                        <IonCol>
                        <IonItem>
                            <IonLabel position="stacked">Name</IonLabel>
                            <IonInput type="text" ref={nameRef} value={prod.name}></IonInput>
                        </IonItem>
                        </IonCol>
                    </IonRow>
                    <IonRow>
                        ...
                        <IonItem>
                            ...
                            <IonSelect value={prod.category} placeholder={prod.category} ref={categoryRef}>
                    ...
                    <IonRow>
                        ...
                        <IonItem>
                            ...
                            <IonInput type="text" ref={priceRef} value={prod.price}></IonInput>
                        </IonItem>
                        </IonCol>
                    </IonRow>
                    <IonRow>
                        ...
                        <IonItem>
                            ...
                            <IonInput type="number" ref={gravityRef} value={prod.gravity}></IonInput>
                        </IonItem>
                        </IonCol>
                    </IonRow>
                    <IonRow>
                        ...
                        <IonItem>
                            ...
                            <IonInput type="number" ref={speedRef} value={prod.effectiveSpeed}></IonInput>
                        </IonItem>
                        </IonCol>
                    </IonRow>
                    <IonRow>
                        ...
                        <IonItem>
                            ...
                            <IonInput type="number" ref={lightingRef} value={prod.lighting}></IonInput>
                        </IonItem>
                        </IonCol>
                    </IonRow>
                    <IonRow>
                        ...
                        <IonItem>
                            ...
                            <IonInput type="number" ref={mrenderRef} value={prod.mrender}></IonInput>
                        </IonItem>
                        </IonCol>
                    </IonRow>
                    <IonRow>
                        ...
                        <IonItem>
                            ...
                            <IonInput type="number" ref={reflectionRef} value={prod.reflection}></IonInput>
                        </IonItem>
                        </IonCol>
                    </IonRow>
                    <IonRow>
                        ...
                        <IonItem>
                            ...
                            <IonInput type="text" ref={releaseRef} value={prod.release}></IonInput>
                        </IonItem>
                        </IonCol>
                    </IonRow>
                    <IonRow>
